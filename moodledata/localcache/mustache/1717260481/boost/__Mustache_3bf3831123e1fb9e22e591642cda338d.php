...
class __Mustache_3bf3831123e1fb9e22e591642cda338d extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section5d331994f88f9acb468bd37a942b8e2f($context, $indent, $value);
        $buffer .= $indent . '	</table>	
';
        $buffer .= $indent . '</div>';
    ...
    private function section5d331994f88f9acb468bd37a942b8e2f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
