...
class __Mustache_b96587127daf0318e6a06ffae85c4d1b extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionCb56bfb06ad73bf3e158dd1332b1f02f($context, $indent, $value);
        $buffer .= '</td>
';
        $buffer .= $indent . '            </tr>
';
...
';
    ...
    private function sectionA1fb741afd54e769c07aa78c101d82d5(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '{{lastname}}&nbsp;{{firstname}}<br>';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
        } elseif (!empty($value)) {
            $values = $this->isIterable($value) ? $value : array($value);
    ...
    private function sectionCb56bfb06ad73bf3e158dd1332b1f02f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
                {{#teacher}}{{lastname}}&nbsp;{{firstname}}<br>{{/teacher}}
              ';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
        } elseif (!empty($value)) {
...
';
                ...
                $buffer .= $this->sectionA1fb741afd54e769c07aa78c101d82d5($context, $indent, $value);
                $buffer .= '
';
                $buffer .= $indent . '              ';
                $context->pop();
